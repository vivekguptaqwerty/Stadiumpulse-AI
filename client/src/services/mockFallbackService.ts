  ...
  getGroundedFanResponse: (
    ...
    if (detectedLang === 'es' && intent === 'FACILITY_SEARCH') {
      return {
        ...
        title: 'Baños más cercanos (Local Mock)',
    ...
    if (detectedLang === 'hi' && intent === 'TRANSPORT') {
      return {
        ...
        title: 'रेलवे मेट्रो मार्ग (Local Mock)',
    ...
    switch (intent) {
      case 'MEDICAL_ASSISTANCE':
        return {
          ...
          title: 'Medical assistance nearby (Local Mock)',
      ...
      case 'NAVIGATION':
        return {
          ...
          title: 'Gate C Crowded: Alternative Route Active (Local Mock)',
      ...
      case 'FACILITY_SEARCH':
        return {
          responseType: 'FACILITY_GUIDANCE',
          title: 'Nearest Restroom (Local Mock)',
      ...
      case 'ACCESSIBILITY_ASSISTANCE':
        return {
          ...
          title: 'Wheelchair Accessible Routes (Local Mock)',
      ...
      case 'MISSING_PERSON':
        return {
          responseType: 'EMERGENCY_GUIDANCE',
          title: 'Guest Assistance Center Support (Local Mock)',
      ...
      default:
        return {
          ...
          title: 'Tournament Companion Support (Local Mock)',
  ...
  analyzeOperations: (snapshot: any): OpsAnalysisResponse => {
    ...
    if (isSurge) {
      return {
        riskDetected: true,
        riskLevel: 'HIGH',
        title: 'Emerging congestion risk at Gate C (Local Mock)',
    ...
    if (isMedical) {
      return {
        riskDetected: true,
        riskLevel: 'HIGH',
        title: 'Active medical incident in Zone B (Local Mock)',
    ...
    return {
      riskDetected: false,
      riskLevel: 'NORMAL',
      title: 'Nominal operations (Local Mock)',
